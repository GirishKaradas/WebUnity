...
package com.genius.unitysample.fragments;
...
import com.genius.unitysample.R;
...
public class MainLayoutFragment extends BaseFragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    if (getArguments() != null) {
      ...
      timestamp.setText(getArguments().getString(TEXT_KEY, getString(R.string.empty_string)));
    }
    return view;
  }
}
